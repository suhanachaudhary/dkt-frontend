  ...
  return (
    <section id="login-gateway" className="py-16 px-6 md:px-20 bg-white">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-600 mb-4 transition-all duration-500">
          Login Gateway
        </h2>
        <p className="text-gray-600 mb-10 text-sm md:text-base max-w-2xl mx-auto transition-opacity duration-500">
        ...
        <div className="flex flex-wrap justify-center gap-5">
          {[
            ...
            <Link to={item.path} key={index}>
              <button
                className="relative bg-green-500 text-white px-6 py-2 rounded-md font-medium text-sm md:text-base 
